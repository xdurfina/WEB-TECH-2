...
//    $mail->SMTPDebug = SMTP::DEBUG_SERVER;
    ...
    $mail->addAddress($to);
    $mail->isHTML(true);
    $mail->Subject = $lang['prelozene5'];
    $mail->Body = '<html lang="en">
    <head>
    <title>'.$lang['prelozene5'].'</title>
    </head>
    <body>
    <table>
    <thead>
    <tr>
        <th>'.$lang['prelozene14'].'</th>
        <th>'.$lang['prelozene28'].'</th>
    </tr>
    </thead>
    <tbody>
    <tr>
        <th>'.$lang['prelozene9'].'</th>
        <td>'.$result_tlmic['sucet'].'</td>
    </tr>
    <tr>
        <th>'.$lang['prelozene10'].'</th>
        <td>'.$result_kyvadlo['sucet'].'</td>
    </tr>
    <tr>
        <th>'.$lang['prelozene8'].'</th>
        <td>'.$result_lietadlo['sucet'].'</td>
    </tr>
    <tr>
        <th>'.$lang['prelozene7'].'</th>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="nav-item">
            <a href="statistika.php?lang=sk"><img src="http://www.geonames.org/flags/x/sk.gif" style="height: 25px; width: 40px; margin-top: 15px"></a>
            <a href="statistika.php?lang=en"><img src="http://www.geonames.org/flags/x/uk.gif" style="height: 25px; width: 40px; margin-top: 15px"></a>
        </ul>
    </div>
</nav>

<br><h2 style="text-align: center"><?php echo $lang['prelozene5']?> </h2>

<table class="table table-bordered" style="width: 500px" align="center">
    <thead>
    <tr>
        <th scope="col"><?php echo $lang['prelozene14']?>:</th>
        <th scope="col"><?php echo $lang['prelozene28']?>:</th>
    </tr>
    </thead>
    <tbody>
    <tr>
...
<form method="post" action="statistika.php" style="text-align: center;">
    <label><input type="email" name="email" id="email"></label>
    <input type="submit" class="btn btn-primary" name="mail" id="mail" value="<?php echo $lang['prelozene15']?>">
</form>
